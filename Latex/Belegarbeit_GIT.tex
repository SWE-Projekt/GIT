...
\lhead{{\footnotesize HTW Berlin}}
\chead{}
\rhead{{\footnotesize SWE - Belegarbeit GIT}}
\lfoot{{\footnotesize F. Goerge, S. Ede,\\ R. Peters, J. Meise}}
\cfoot{}
\rfoot{\thepage}
...
\newglossaryentry{merge}{name=merge,description={engl. zusammenführen}}
...
%---Bsp. um Text einzurücken (optional)--------------------------------------------	
\par
\begingroup
\leftskip=1,1cm 
